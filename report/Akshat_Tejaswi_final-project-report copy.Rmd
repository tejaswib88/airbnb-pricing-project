...
To begin with, we ran a cross validated ridge regression model on the price against the 35 explanatory variables. Figure \@ref(fig:ridge-features) showcases the top 10 features selected first by the ridge model. 
